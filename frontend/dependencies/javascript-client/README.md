...
DBqueryBench - JavaScript client for d_bquery_bench
...
```shell
npm install d_bquery_bench --save
```
...
Finally, switch to the directory you want to use your d_bquery_bench from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('d_bquery_bench')` in javascript files from the directory you ran the last 
command above from.

#### git
#
If the library is hosted at a git repository, e.g.
https://github.com/YOUR_USERNAME/d_bquery_bench
then install it via:

```shell
    npm install YOUR_USERNAME/d_bquery_bench --save
```
